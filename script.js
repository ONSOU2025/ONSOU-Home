...
const newsData = [
    {
        title: '📸 スクリーンショット機能の改善/変更について',
        date: '2025.12.14',
        category: 'お知らせ',
        content: 'リザルト画面のスクリーンショット機能について、改善または変更がありましたのでお知らせいたします。　リザルトのスコア表記横にあるカメラボタンを押してスクリーンショットを撮る機能が、以下の通り更新されました。　🌟 変更・改善点　画質向上: スクリーンショット画像がより見やすくなりました。　保存場所の変更: 画像の保存場所が以下のように変更されました。　保存場所はデスクトップに新しく作成される「音奏スクリーンショット画像フォルダ」というフォルダになります。　⚠️ 重要なお願い：フォルダの取り扱いについて　この新しい機能が正常に動作し続けるために、以下の2点について厳守をお願いいたします。　「 音奏スクリーンショット画像フォルダ 」をデスクトップから移動しないでください。　「 音奏スクリーンショット画像フォルダ 」に関係のないファイルなどを入れないでください。　スムーズなゲーム体験のために、ご協力をお願いいたします。'
    },
    {
        title: '音奏最新バージョンva1.0.0.27公開！',
        date: '2025.12.14',
        category: 'お知らせ',
        content: '「音奏最新バージョンva1.0.0.27」を本日より配信開始！ダウンロードはPlayの欄からダウンロードページに移動できます。'
    },
    {
